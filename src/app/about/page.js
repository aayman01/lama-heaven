            ...
            <div className="text-center w-full h-[550px] bg-slate-100 pt-28">
                ...
                <div className="flex justify-center pt-14">
                    <div className="w-[350px] mr-5 h-[200px] text-blue-900 bg-white shadow-xl rounded-lg shadow-slate-200">
                        <div className="w-11 h-11 ml-[150px] mt-10 ">
                        ...
                        <h1 className="pt-5 text-2xl font-semibold">Integrity</h1>
                        <p className="text-lg">We act with  in all that we do.</p>
                    </div>
                    <div className="w-[350px] mr-5 h-[200px] text-blue-900 bg-white shadow-xl rounded-lg shadow-slate-200">
                        <div className="w-11 h-11 ml-[150px] mt-10 ">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#004080" d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z" /></svg>
                        </div>
                        <h1 className="pt-5 text-2xl font-semibold">Trust</h1>
                        <p className="text-lg">We act with  in all that we do.</p>
                    </div>
                    <div className="w-[350px] h-[200px] text-blue-900 bg-white shadow-xl rounded-lg shadow-slate-200">
                        <div className="w-11 h-11 ml-[150px] mt-10 ">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#004080" d="M448 256A192 192 0 1 0 64 256a192 192 0 1 0 384 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 80a80 80 0 1 0 0-160 80 80 0 1 0 0 160zm0-224a144 144 0 1 1 0 288 144 144 0 1 1 0-288zM224 256a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z" /></svg>
                        </div>
                        <h1 className="pt-5 text-2xl font-semibold">Honesty</h1>
                        <p className="text-lg">We act with  in all that we do.</p>
                    </div>
                </div>
            </div>

            <div className="text-center w-full h-[400px] bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
                <div className="w-16 h-16 ml-[725px] pt-16 ">
